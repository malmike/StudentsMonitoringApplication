...
namespace SMA.Model.PhpRetrieval
{
    class GetTeacherSubject
    {
        ...
        public async Task<string> getDetails(string address, string teacherId, string action)
        {
            ...
            try
            {
                ...
                content.Add((new StringContent(teacherId, System.Text.Encoding.UTF8, "text/plain")), "teacherId");
