...
namespace SMA.Resources
{
    class Login
    {
        ...
        public async Task<string> getDetails(string address, string user, string email, string password, string action)
        {
            ...
            try
            {
                ...
                content.Add((new StringContent(email, System.Text.Encoding.UTF8, "text/plain")), "Email");
                content.Add((new StringContent(password, System.Text.Encoding.UTF8, "text/plain")), "Password");
